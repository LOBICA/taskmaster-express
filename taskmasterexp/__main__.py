...
from taskmasterexp.auth import cli as auth_cli
from taskmasterexp.database import cli as database_cli
from taskmasterexp.paypal import cli as paypal_cli
