...
from taskmasterexp.chatbot.errors import MessageTooLongError
from taskmasterexp.chatbot.messages import _send_split_message
...
@patch("taskmasterexp.chatbot.messages._send_message")
